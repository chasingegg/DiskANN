...
query_path = '/home/ubuntu/LEQAT/data/sift1M/query.fbin'
ground_truth_path = '/home/ubuntu/LEQAT/data/sift1M/gt_qa.ibin'
index_path_prefix = '/home/ubuntu/index/diskann'
output_path_prefix = '/home/ubuntu/index/log'
K= 10
W = 1
T= 8
C = 200
...
if index.load_index(index_path_prefix, num_threads, num_nodes_to_cache) != 0:
    ...
    if single_query_mode:
        print("Ls     QPS     Mean Latency (ms)     99.9 Latency     Recall@10")
        print("================================================================")
